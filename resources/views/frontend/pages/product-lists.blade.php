                                    ...
                                    @foreach($recent_products as $product)
                                        ...
                                        <div class="single-post first">
                                            ...
                                            <div class="content">
                                                ...
                                                @endphp
                                                <p class="price"><del class="text-muted">AFN{{number_format($product->price,2)}}</del>   AFN{{number_format($org,2)}}  </p>                                                
                                            </div>
                                        </div>
                                        <!-- End Single Post -->
                                    @endforeach
													...
													<div class="list-content">
														<div class="product-content">
															<div class="product-price">
																...
																@endphp
																<span>AFN{{number_format($after_discount,2)}}</span>
																<del>AFN{{number_format($product->price,2)}}</del>
															</div>
															<h3 class="title"><a href="{{route('product-detail',$product->slug)}}">{{$product->title}}</a></h3>
														{{-- <p>{!! html_entity_decode($product->summary) !!}</p> --}}
														</div>
														<p class="des pt-2">{!! html_entity_decode($product->summary) !!}</p>
														<a class="btn cart" href="{{route('product-detail',$product->slug)}}">Buy Now!</a>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
											<div class="quickview-content">
												...
												@php
													$after_discount=($product->price-($product->price*$product->discount)/100);
												@endphp
												<h3><small><del class="text-muted">AFN{{number_format($product->price,2)}}</del></small>AFN{{number_format($after_discount,2)}}  </h3>
